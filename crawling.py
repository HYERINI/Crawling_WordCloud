...
driver = webdriver.Chrome("C:/Users/이혜린/Downloads\chromedriver_win32/chromedriver.exe")
...
musics = soup.select('#body-content > div.newest-list > div > table > tbody > tr')  #copy selector
